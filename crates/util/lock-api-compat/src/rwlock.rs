...
// CVE-2020-35913: RwLockReadGuard must require R: Sync to be Sync.
unsafe impl<'a, R: RawRwLock + Sync + 'a, T: ?Sized + Sync + 'a> Sync for RwLockReadGuard<'a, R, T> {}
...
// CVE-2020-35914: RwLockWriteGuard must require R: Sync to be Sync.
unsafe impl<'a, R: RawRwLock + Sync + 'a, T: ?Sized + Sync + 'a> Sync for RwLockWriteGuard<'a, R, T> {}
...
// CVE-2020-35911: MappedRwLockReadGuard must require T: Sync to be Send.
...
// CVE-2020-35912: MappedRwLockWriteGuard must require T: Send to be Send.
