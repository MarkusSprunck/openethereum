...
time cargo build --color=always --release --features final
time cargo build --color=always --release -p evmbin
time cargo build --color=always --release -p ethstore-cli
time cargo build --color=always --release -p ethkey-cli
